...
import { getMyMetrics, getMyExerciseSessionSeries } from "@/lib/supabase/metrics";
...
export default async function ProgressStatsPage() {
  const [stats, sessionSeries, metricsWeek, metricsMonth, metricsBlock] =
    await Promise.all([
      getClientStats(),
      getMyExerciseSessionSeries(),
      getMyMetrics("week"),
      getMyMetrics("month"),
      getMyMetrics("block"),
    ]);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <StatsCharts stats={stats} sessionSeries={sessionSeries} />
